...
Evaluation of different data split strategies are performed on the FewGLUE benchmark. In the [paper](https://arxiv.org/pdf/2109.12742.pdf)(https://arxiv.org/pdf/2009.07118.pdf)) the authors have assessed approaches based on the frequently applied prompt-based few-shot PET method taking DeBERTa as the base model.  Throughout the experiment learning rate, evaluation ratio, prompt pattern and maximum training step, hyperparameters are considered and are run on the same set of tasks. 
